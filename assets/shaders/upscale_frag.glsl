...
{
    vec4 v1 = texelFetch(tex, ivec2(uv + vec2(p1.x, p1.y)), 0);
    vec4 v2 = texelFetch(tex, ivec2(uv + vec2(p2.x, p2.y)), 0);
    if (length(v1 - v2) < 0.00999999977648258209228515625)
    {
        vec2 dir = p2 - p1;
        vec2 lp = uv - (floor(uv + p1) + vec2(0.5));
        dir = normalize(vec2(dir.y, -dir.x));
        float l = clamp((LINE_THICKNESS - dot(lp, dir)) * 7.19999980926513671875, 0.0, 1.0);
...
void main()
{
    ...
    vec2 ip = uv / vec2(4.0);
    vec4 s = texelFetch(tex, ivec2(int(ip.x), int(ip.y)), 0);
    LINE_THICKNESS = 0.5;
    vec4 param = s;
    vec2 param_1 = ip;
    ...
    if (_143)
    {
        ...
        vec4 param_4 = s;
        vec2 param_5 = ip;
        vec2 param_6 = vec2(-1.0, 0.0);
        vec2 param_7 = vec2(1.0);
        bool _155 = diag(param_4, param_5, param_6, param_7);
        s = param_4;
        vec4 param_8 = s;
        vec2 param_9 = ip;
        vec2 param_10 = vec2(-1.0);
    ...
    vec4 param_12 = s;
    vec2 param_13 = ip;
    vec2 param_14 = vec2(0.0, 1.0);
    vec2 param_15 = vec2(1.0, 0.0);
    ...
    if (_174)
    {
        ...
        vec2 param_19 = vec2(1.0, -1.0);
        bool _185 = diag(param_16, param_17, param_18, param_19);
        s = param_16;
        vec4 param_20 = s;
        vec2 param_21 = ip;
        vec2 param_22 = vec2(-1.0, 1.0);
        vec2 param_23 = vec2(1.0, 0.0);
    ...
    vec4 param_24 = s;
    vec2 param_25 = ip;
    vec2 param_26 = vec2(1.0, 0.0);
    vec2 param_27 = vec2(0.0, -1.0);
    ...
    if (_204)
    {
        ...
        vec4 param_28 = s;
        vec2 param_29 = ip;
        vec2 param_30 = vec2(1.0, 0.0);
        vec2 param_31 = vec2(-1.0);
        bool _214 = diag(param_28, param_29, param_30, param_31);
        s = param_28;
        vec4 param_32 = s;
        vec2 param_33 = ip;
        vec2 param_34 = vec2(1.0);
        vec2 param_35 = vec2(0.0, -1.0);
    ...
    vec4 param_36 = s;
    vec2 param_37 = ip;
    vec2 param_38 = vec2(0.0, -1.0);
    vec2 param_39 = vec2(-1.0, 0.0);
    ...
    if (_230)
    {
        ...
        vec4 param_40 = s;
        vec2 param_41 = ip;
        vec2 param_42 = vec2(0.0, -1.0);
        vec2 param_43 = vec2(-1.0, 1.0);
        bool _240 = diag(param_40, param_41, param_42, param_43);
        s = param_40;
        vec4 param_44 = s;
        vec2 param_45 = ip;
        vec2 param_46 = vec2(1.0, -1.0);
        vec2 param_47 = vec2(-1.0, 0.0);
