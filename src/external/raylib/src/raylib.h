...
#define RLIGHTGRAY  CLITERAL(Color){ 200, 200, 200, 255 }   // Light Gray
#define RGRAY       CLITERAL(Color){ 130, 130, 130, 255 }   // Gray
#define RDARKGRAY   CLITERAL(Color){ 80, 80, 80, 255 }      // Dark Gray
#define RYELLOW     CLITERAL(Color){ 253, 249, 0, 255 }     // Yellow
#define RGOLD       CLITERAL(Color){ 255, 203, 0, 255 }     // Gold
#define RORANGE     CLITERAL(Color){ 255, 161, 0, 255 }     // Orange
#define RPINK       CLITERAL(Color){ 255, 109, 194, 255 }   // Pink
#define RRED        CLITERAL(Color){ 230, 41, 55, 255 }     // Red
#define RMAROON     CLITERAL(Color){ 190, 33, 55, 255 }     // Maroon
#define RGREEN      CLITERAL(Color){ 0, 228, 48, 255 }      // Green
#define RLIME       CLITERAL(Color){ 0, 158, 47, 255 }      // Lime
#define RDARKGREEN  CLITERAL(Color){ 0, 117, 44, 255 }      // Dark Green
#define RSKYBLUE    CLITERAL(Color){ 102, 191, 255, 255 }   // Sky Blue
#define RBLUE       CLITERAL(Color){ 0, 121, 241, 255 }     // Blue
#define RDARKBLUE   CLITERAL(Color){ 0, 82, 172, 255 }      // Dark Blue
#define RPURPLE     CLITERAL(Color){ 200, 122, 255, 255 }   // Purple
#define RVIOLET     CLITERAL(Color){ 135, 60, 190, 255 }    // Violet
#define RDARKPURPLE CLITERAL(Color){ 112, 31, 126, 255 }    // Dark Purple
#define RBEIGE      CLITERAL(Color){ 211, 176, 131, 255 }   // Beige
#define RBROWN      CLITERAL(Color){ 127, 106, 79, 255 }    // Brown
#define RDARKBROWN  CLITERAL(Color){ 76, 63, 47, 255 }      // Dark Brown

#define FULLWHITE      CLITERAL(Color){ 255, 255, 255, 255 }   // White
#define RBLACK      CLITERAL(Color){ 0, 0, 0, 255 }         // Black
#define BLANK      CLITERAL(Color){ 0, 0, 0, 0 }           // Blank (Transparent)
#define RMAGENTA    CLITERAL(Color){ 255, 0, 255, 255 }     // Magenta
